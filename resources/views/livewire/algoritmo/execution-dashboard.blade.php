<div data-solver-dashboard>
    ...
    @livewire(\App\Livewire\Algoritmo\ExecutionMetricsStream::class, ['executionId' => $execution->id, 'horarioId' => $execution->horario_id], key('execution-metrics-' . $execution->id))
