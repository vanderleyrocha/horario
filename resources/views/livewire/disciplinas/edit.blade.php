    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">Editar Disciplina</h2>
                    <p class="text-gray-600 mt-1">Atualize as informações da disciplina</p>
                </div>
                <button 
                    wire:click="delete"
                    wire:confirm="Tem certeza que deseja excluir esta disciplina? Esta ação não pode ser desfeita."
        ...
        <form wire:submit="update" class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-6">
            ...
            <div class="p-4 bg-gray-50 rounded-lg border border-gray-200">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-700">Status da Disciplina</p>
                        <p class="text-xs text-gray-500 mt-1">Ative ou desative a disciplina no sistema</p>
                    </div>
                ...
                <div class="p-4 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    <div class="flex items-center space-x-3 p-3 bg-white rounded-lg border border-gray-200">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500">{{ $codigo }} • {{ $carga_horaria_semanal }}h/semana</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="flex">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-blue-700 mt-1">
                            Cadastrado em: {{ $disciplina->created_at->format('d/m/Y H:i') }}<br>
                            Última atualização: {{ $disciplina->updated_at?->format('d/m/Y H:i') }}
                        </p>
                    </div>
                </div>
            </div>
