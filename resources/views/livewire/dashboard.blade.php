...
<div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        @foreach ($this->stats as $stat)
            <a href="{{ route($stat['route']) }}" wire:navigate class="bg-white rounded-lg shadow-sm p-6 border border-gray-200 hover:shadow-md transition-shadow">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200 mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <a href="{{ route('professores.create') }}" wire:navigate class="flex items-center p-4 border-2 border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-all">
            ...
            <a href="{{ route('turmas.create') }}" wire:navigate class="flex items-center p-4 border-2 border-gray-200 rounded-lg hover:border-green-500 hover:bg-green-50 transition-all">
            ...
            <a href="{{ route('horarios.create') }}" wire:navigate class="flex items-center p-4 border-2 border-gray-200 rounded-lg hover:border-purple-500 hover:bg-purple-50 transition-all">
