        ...
        <div class="col-span-2 rounded bg-white p-4 shadow">
            ...
            <div class="mt-4 grid gap-4 text-sm lg:grid-cols-2">
                <div class="rounded-xl border border-slate-200 bg-slate-50/80 px-4 py-3">
                    <p class="text-sm font-semibold text-slate-900">Episodio atual</p>
                    <p class="mt-1 font-semibold text-slate-800" data-landscape-current-episode-title>
                        Nenhum episodio ativo ainda
                    </p>
                    <p class="mt-2 text-sm text-slate-600" data-landscape-current-episode-detail>
                        O dashboard exibira inicio, duracao e intensidade maxima do episodio atual.
                    </p>
                </div>
                <div class="rounded-xl border border-slate-200 bg-slate-50/80 px-4 py-3">
                    <p class="text-sm font-semibold text-slate-900">Ultimo episodio encerrado</p>
                    <p class="mt-1 font-semibold text-slate-800" data-landscape-previous-episode-title>
                        Nenhum episodio encerrado ainda
                    </p>
                    <p class="mt-2 text-sm text-slate-600" data-landscape-previous-episode-detail>
                        Quando um episodio terminar, o dashboard exibira como ele terminou e qual foi o pico de intensidade.
                    </p>
                </div>
            </div>
            <div class="mt-4 rounded-xl border border-slate-200 bg-slate-50/80 px-4 py-3">
                <div class="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                    <div>
                        <p class="text-sm font-semibold text-slate-900">Transicao relevante</p>
                        <p class="mt-1 text-sm text-slate-600" data-landscape-transition-detail>
                            O dashboard destacara entradas em vale profundo, mudancas de fenomeno e recuperacoes assim que elas aparecerem.
                        </p>
                    </div>
                    <span
            ...
            <div class="mt-4 rounded-xl border border-slate-200 bg-slate-50/80 px-4 py-3">
                <div class="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                    <div>
                        <p class="text-sm font-semibold text-slate-900">Tendencia recente</p>
                        <p class="mt-1 text-sm text-slate-600" data-landscape-trend-detail>
                            A tendencia entre episodios sera destacada quando houver sequencia suficiente para comparacao.
                        </p>
                    </div>
                    <span
                        class="inline-flex w-fit rounded-full border border-slate-200 bg-white px-3 py-1 text-xs font-semibold text-slate-700"
            ...
            <div class="mt-4 rounded-xl border border-slate-200 bg-slate-50/80 px-4 py-3">
                <p class="text-sm font-semibold text-slate-900">Historico recente de transicoes</p>
                <div class="mt-3 space-y-2" data-landscape-transition-history>
                    <p class="rounded-lg border border-dashed border-slate-300 px-3 py-2 text-sm text-slate-500">
