...
it('adjusts destroy and repair intensity using landscape pressure and recent alns effectiveness', function (): void {
    $destroy = new AdaptiveFakeDestroyOperator('ConflictDestroy');
    $repair = new AdaptiveFakeRepairOperator('RegretInsertion', [7.0, 6.8]);
...
final class AdaptiveFakeDestroyOperator implements AdaptiveDestroyOperatorInterface, DestroyOperatorInterface
{
    /**
     * @var list<float>
     */
...
final class AdaptiveFakeRepairOperator implements AdaptiveRepairOperatorInterface, RepairOperatorInterface
{
    /**
     * @var list<float>
     */
    ...
    /**
     * @param  list<float>  $resultFitnessSequence
     */
    public function __construct(
        private readonly string $name,
