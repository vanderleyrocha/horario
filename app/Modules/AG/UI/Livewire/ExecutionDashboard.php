...
class ExecutionDashboard extends Component
{
    ...
    public function getStatusContextProperty(): array
    {
        return is_array($this->execution->status_context_json)
    ...
    public function render()
    {
        ...
        return view('modules.ag.livewire.algoritmo.execution-dashboard', [
